        ...
        initDraggableEntityRows: function() {
            if(document.body.classList.contains('easyadmin') && document.body.classList.contains('list')) {
                ...
                function handleDragStart(e) {
                    ...
                    console.log(dragSrcEl.offsetHeight);
                    entityId = dragSrcEl.getAttribute('data-id');
                    dragSrcEl.style.opacity = '0.1';
                    //dragSrcEl.style.height = dragSrcEl.offsetHeight / 100 * 20 +'px !important';
                ...
                function handleDrop(e) {
                    ...
                    if (dragSrcEl !== this) {
                        ...
                        xhr.open('GET', (encodeURI('/manage/sort/' + entityClass + '/' + entityId + '/' + endPosition + '?filters=' + JSON.stringify(urlParams.filters))));
